...
const productNav = [
  ...
  { to: APP_ROUTES.testSeriesCatalog, label: "Test Series", icon: ClipboardList },
...
export function AppShell() {
  ...
  const isAuthless = path === APP_ROUTES.onboardingProfile
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <Separator />
      <div className={cn("mx-auto w-full max-w-6xl px-4 py-8", isAuthless ? "max-w-5xl" : "max-w-6xl")}>
